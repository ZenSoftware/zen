...
I have strictly kept to the Angular and Nest best practices that are being utilized within the ecosystem.  All the services being generated should be fairly self explanatory, and lots of useful NPM scripts have been provided for the various stages between all the stages of development through to deployment. Better documentation will come with time. 🍜
