...
I have strictly kept to the Angular and Nest best practices, and all the services being generated should be fairly self explanatory, but better documentation will come with time.
